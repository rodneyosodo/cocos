...
type Algorithm struct {
	...
	Hash    []byte `protobuf:"bytes,2,opt,name=hash,proto3" json:"hash,omitempty"` // should be sha3.Sum256, 32 byte length.
...
var file_manager_manager_proto_rawDesc = []byte{
	...
	0x28, 0x0c, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x4b, 0x65, 0x79, 0x22, 0x4d, 0x0a, 0x09, 0x41,
